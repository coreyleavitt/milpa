...
- [ ] S3 — verification-steps normative pin + leaf-cert caveat + no-revocation NOTE + subject-cardinality=1 (D3) **+ reconcile stage 5/6/7 signer-vs-Rekor ordering (see obligation above)**
