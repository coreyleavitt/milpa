...
passes every fixture in `tests/conformance/spec-v1/`. The conformance suite
...
| **conformance spec version** | `tests/conformance/spec-v<N>/` | this specification as a whole |
