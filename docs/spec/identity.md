...
- `docs/spec/errors.md` — `ID-*` and `CAS-*` error codes
- `docs/spec/manifest-grammar.md` (S4) — manifest grammar; `cas { dir }` field
- `docs/spec/lockfile-schema.md` (S5) — lockfile `identity` field;
  `nim.cfg --path:` dependence on the CAS symlink layout
- `docs/spec/plugin-contract.md` (S10) — fetcher contract; registry computes
...
All identity and CAS errors are defined in `docs/spec/errors.md`. Summary:
