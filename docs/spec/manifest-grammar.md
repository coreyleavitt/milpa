...
- `docs/spec/errors.md` — every error code this grammar can produce
- `docs/spec/lockfile-schema.md` (S5) — lockfile representation of provenance
- `docs/spec/resolver-semantics.md` (S6) — pre-solver predicate evaluation
- `docs/spec/plugin-contract.md` (S10) — Layer 2 backend-binding contract
...
> constraint grammar is defined in `docs/spec/resolver-semantics.md` (S6).
...
> content-addressed store. See §4.3 and `docs/spec/plugin-contract.md` (S10).
...
> normatively in `docs/spec/lockfile-schema.md` (S5).
...
>
> See `docs/spec/resolver-semantics.md` §9 for the normative resolver rule.
...
> See `docs/spec/plugin-contract.md` (S10) for the full backend contract.
...
> lockfile↔spec-version mapping is owned by S5 (`docs/spec/lockfile-schema.md`)
...
> `docs/spec/resolver-semantics.md` (S6) for the full evaluation semantics.
...
`docs/spec/resolver-semantics.md` (S6). The syntax rules that govern what the
