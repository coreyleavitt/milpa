...
Discovers every tests/conformance/spec-v<N>/fixture-NNN-<slug>/ directory
and parametrizes one pytest case per fixture.

Fixture layout (per docs/spec/conformance-fixtures.md):
...
_CONFORMANCE_ROOT = Path(__file__).parent / "conformance"
